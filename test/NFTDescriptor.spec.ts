...
describe('NFTDescriptor', () => {
  ...
  function constructTokenMetadata(
    ...
    return {
      name: `ETH AF - ${feeTier} - ${quoteTokenSymbol}/${baseTokenSymbol} - ${prices}`,
      description: `This NFT represents a liquidity position in a ETH AF ${quoteTokenSymbol}-${baseTokenSymbol} pool. The owner of this NFT can modify or redeem the position.\n\
